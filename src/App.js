...
function App() {
  ...
  return <main>
    ...
    <section className="hero" id="home"><div className="hero-copy"><p className="eyebrow"><span /> Available for new opportunities</p><h1>Building digital<br /><em>experiences</em> that<br />feel effortless.</h1><p className="hero-description">I’m Abbas Bohra, a React Native developer focused on creating fast, polished products for web and mobile.</p><div className="hero-actions"><a className="button button-primary" href="#work">Explore my work <FaArrowDown /></a><a className="text-link" href="#contact">Get in touch <FaArrowUpRightFromSquare /></a></div></div><div className="hero-art" aria-hidden="true"><div className="orb orb-one" /><div className="orb orb-two" /><div className="illustration-shell"><DeveloperIllustration /></div><div className="floating-note note-top">React Native<br /><b>Developer</b></div><div className="floating-note note-bottom">Based in<br /><b>Rajasthan, India</b></div></div><a className="scroll-cue" href="#about"><span>Scroll to discover</span><i /></a></section>
    <section className="about section-wrap" id="about"><p className="section-kicker">01 — ABOUT ME</p><div className="about-grid"><h2>I turn complex ideas into <em>clear, useful</em> digital products.</h2><div className="about-text"><p>I’m a React Native developer who cares about the details: thoughtful interfaces, maintainable code, and experiences people actually enjoy using.</p><p>From early concepts to reliable releases, I collaborate with teams to make mobile and web products feel simple on the surface and solid underneath.</p><a className="text-link" href="#experience">More about my journey <FaArrowDown /></a></div></div><div className="stats"><div><strong>2+</strong><span>Years building<br />digital products</span></div><div><strong>6</strong><span>Featured<br />projects</span></div><div><strong>3</strong><span>Languages<br />spoken</span></div></div></section>
